...
describe('applyShaderFile — JSON Sliders GL preset', () => {
  beforeEach(() => {
    state.editor = _mockEditor();
    vi.clearAllMocks();
  });

  it('reconnaît un preset Sliders GL (a id + code)', async () => {
  ...
  it('affiche un toast si le JSON n\'est ni Shadertoy ni Sliders GL', () => {
