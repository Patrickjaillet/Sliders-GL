...
function _openPicker(ln, info, clientX, clientY) {
  ...
  if (!document.getElementById('zgl-pop-style')) {
    ...
    st.id = 'zgl-pop-style';
    st.textContent = `
      .zgl-color-pop{position:fixed;z-index:9999;background:var(--bg-surface,#cdcdcd);border:1px solid var(--border,#a8a8a8);border-radius:6px;padding:8px;display:flex;flex-direction:column;gap:5px;box-shadow:0 4px 20px rgba(0,0,0,.25);min-width:180px;font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--prose,#242424);}
