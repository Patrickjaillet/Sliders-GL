...
// A Sliders GL-scoped quick-open overlay listing every meaningful editor/app action.
...
function openCommandPalette() {
  ...
  input.type = 'text';
  input.placeholder = '⌨  Sliders GL commands…';
...
(function initMonaco() {
  ...
  // they appear in the Sliders GL command palette and the keybinding is discoverable.
  state.editor.addAction({
  ...
  // 2.1: Command Palette — Ctrl+Shift+P opens Sliders GL-scoped palette.
...
export { GLSL_BUILTINS, SHADERTOY_UNIFORMS };
