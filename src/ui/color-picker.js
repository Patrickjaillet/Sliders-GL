...
function _injectStyles() {
  ...
  s.textContent = `
    ...
    #hslAlphaVal { position: absolute; right: -20px; top: 0; font-size: 9px; color: var(--t3, #666); }
    ...
    .hsl-hist-swatch:hover { outline: 2px solid var(--accent, #5b8df6); }
  `;
