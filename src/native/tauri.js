 ...
 * @param {string} shaderName - shown as "<shaderName> - Z-GL"
 */
...
/**
 * Clears all Z-GL application data from disk (presets, localStorage snapshot,
...
export async function clearAppData() {
  ...
  if (ask) {
    const confirmed = await ask(
      'This will permanently delete all Z-GL app data:\n' +
      ...
      'Continue?',
      { title: 'Reset all Z-GL data', kind: 'warning' }
    );
