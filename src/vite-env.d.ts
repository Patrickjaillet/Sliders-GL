...
// CDN URL imports
declare module 'https://*' { const v: any; export = v; export default v; }
...
interface Window {
  ...
  // Internal Z-GL state attached to window
  _zglSensors?: any;
  _zglHwCbs?: any;
  // Open index signature — many Z-GL subsystems attach named callbacks to window
  [key: string]: any;
}
...
interface HTMLElement {
  ...
  // Custom Z-GL properties attached at runtime
  _monacoEditor?: any;
  _zglSensors?: any;
