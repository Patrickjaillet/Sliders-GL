...
// Contenu racine :
//   { version: '2.0', type: 'preset', payload: <objet preset> }
...
/**
 * Importe un fichier .z-gl-preset
 * @param {File} file
 * @param {{ toast, renderLibrary }} ctx
 */
export async function importPresetFile(file, { toast, renderLibrary }) {
  try {
